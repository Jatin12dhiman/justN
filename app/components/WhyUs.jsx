    ...
    <div className="relative py-16 bg-white overflow-hidden">
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative h-[500px] md:h-[600px] flex items-center justify-center">
          ...
          <div className="absolute  -translate-x-1/2 bottom-0 w-[170px] h-[190px] sm:w-[230px] sm:h-[230px] lg:w-[300px] lg:h-[300px] bg-gray-200 rounded-t-full rounded-md overflow-hidden shadow-xl z-10 left-[65%]">
            <Image
              src="/images/w1.png"
              alt="Modern house"
              width={300}
                ...
                >
                  {i === 0 && (
                    <path
                      ...
                      d="M9 12l2 2 4-4m5.618-4.018A9.955 9.955 0 0112 2.118C7.172 2.118 3.118 6.172 3.118 11s4.054 8.882 8.882 8.882 8.882-4.054 8.882-8.882zm-8.882 0a1 1 0 000-2 1 1 0 000 2z"
                    />
                  )}
                  {i === 1 && (
                    <path
                  ...
                  {i === 2 && (
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M17 20h-4a2 2 0 01-2-2v-3.586a1 1 0 00-.293-.707L6.707 9.293A2 2 0 016 7.828V5a2 2 0 012-2h8a2 2 0 012 2v2.828a2 2 0 01-.707 1.414L13 14.414V18a2 2 0 01-2 2z"
                    />
                  )}
                  {i === 3 && (
                    <>
                      ...
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        d="M19.5 10.5a7.5 7.5 0 10-15 0 7.5 7.5 0 0015 0z"
                      />
                    </>
                  )}
                </svg>
